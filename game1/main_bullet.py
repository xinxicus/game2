...
for i in range(num_of_bullets):
  bullets_img.append(pygame.image.load('bullet.png'))
  bullets_x.append(0)
...
def fire_bullet(x, y, i):
  ...
  screen.blit(bullets_img[i],(x+16, y+10))
  screen.blit(bullets_img[i], (x-10, y+10))
  screen.blit(bullets_img[i], (x+40, y+10))
